$(document).on("ready", function(){
  setTimeout(function(){
    ...
    var maxSpeed      = segmentLength/(step*3);      // top speed (ensure we can't move more than 1 segment in a single frame to make collision detection easier)
    ...
    */
    ...
    var ROAD = {
      LENGTH: { NONE: 0, SHORT:  50, MEDIUM:  80, LONG:  200 },
      HILL:   { NONE: 0, LOW:    50, MEDIUM:  80, HIGH:   150 },
